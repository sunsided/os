...
[INFO] uefi_loader: Loaded 3164624 bytes of kernel.elf
[INFO] uefi_loader: Loading kernel segments into memory ...
[INFO] uefi_loader: Load userland bundle into memory ...
[INFO] uefi_loader: Loaded 760712 bytes of user.bundle
[INFO] uefi_loader: kernel.elf loaded successfully: entry=0xFFFFFFFF8010F1A4, segments=2
[INFO] uefi_loader::framebuffer: Obtaining Graphics Output Protocol (GOP)
[INFO] uefi_loader: Kernel boot info: 0x000000000eb91000
[DEBUG] uefi_loader: Allocating trampoline stack for Kernel (0x000000000E368830, 65536 bytes)
...
[INFO] uefi_loader::vmem: Identity map trampoline code at 0x000000000E368830 ...
[INFO] uefi_loader::vmem: Identity map bootinfo pointer ...
[INFO] uefi_loader::uefi_mmap: Exiting boot services ...
[DEBUG] uefi_loader::uefi_mmap: Boot services exited, we're now flying by instruments.
...
[INFO] uefi_loader::tracing: Boot Info in UEFI Loader:
  Kernel   = VA(0xFFFFFFFF8010F1A4)
  Trampol. = VA(0x000000000E3C5FF8)
  BI ptr   = 0x000000000eb91000 (@235 MiB)
       VA  = VA(0x000000000EB91000)
  MMAP ptr = 0x000000000eb84000 (@235 MiB), len = 7152, desc size = 48, desc ver = 1, rsdp addr = 263708692
...
[INFO] uefi_loader: Setting no-execute support for page tables (EFER.NXE) ...
...
[INFO] kernel::tracing: Boot Info in Kernel:
  BI ptr   = 0x000000000eb91000
  MMAP ptr = 0x000000000eb84000, len = 7152, desc size = 48, desc ver = 1, rsdp addr = 263708692
...
[INFO] kernel::init: Syscall entry stubs at 0xFFFFFFFF80103E74
[INFO] kernel::init: Remapping UEFI GOP framebuffer (4096000 bytes) ...
[INFO] kernel::init: Remapped frame buffer to 0xFFFF898000000000
[INFO] kernel::init: Remapping userland bundle (234479616 bytes) ...
[INFO] kernel::init: Remapped userland bundle to 0xFFFF8A8000000000
[INFO] kernel::init: Initializing IDT ...
[INFO] kernel::init: Installing interrupt handlers ...
[INFO] kernel::init: Estimating TSC frequency ...
[INFO] kernel::init: TSC frequency = 4011318300 Hz (4.01 GHz)
...
[INFO] kernel::init: Enabling Supervisor Mode Execution and Access Prevention (SMEP/SMAP)
[INFO] kernel::init: Kernel early init is done, jumping into kernel main loop ...
[INFO] kernel: Kernel doing kernel things now ...
[INFO] kernel::userland: Userland bundle has 1 entries
[INFO] kernel::userland: Init binary is 760632 bytes
[DEBUG] kernel::userland: Mapping user binary code ...
[DEBUG] kernel::userland: Mapping user binary stack ...
[INFO] kernel: Observed timer rate ≈ 1000 Hz
[INFO] kernel: Kernel cycle: 1 s
[INFO] kernel: Kernel cycle: 2 s
[INFO] kernel: About to enter user mode ...
...
[INFO] kernel::alloc::debug: L2[  2]=000000000011a027 P=true RW=true US=true PS=false NX=false
[INFO] kernel::alloc::debug: L1[  0]=0000000000117005 P=true RW=false US=true NX=false
[INFO] kernel: Jumping into userland code - will not refresh screen anymore
[INFO] kernel::userland: Entering user mode ...
Init process started successfully!
Performing legacy INT80h syscall ...
Returned value: 0xD34DC0D3
Performing syscall ...
Returned value: 0xB007C4FE
```
