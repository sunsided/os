...
- Line [175](./os/kernel/kernel/src/init.rs#L175): Restrict allocator to actual available RAM size.
- Line [315](./os/kernel/kernel/src/init.rs#L315): Use a different IST from PF
